# Fraud Detection Coding Challenge (TypeScript)

A TypeScript coding challenge that implements a fraud detection system for credit card transactions.
...
Implement the `calculateTransactionFraudScore()` function in `fraud-analysis.ts` to make all 22 test transactions pass.
...
- **rulesTriggered**: Array of rule names that triggered on this transaction
